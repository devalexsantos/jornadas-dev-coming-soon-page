    ...
    <main className="min-h-screen bg-[url('/img/bg-mobile.png')] md:bg-[url('/img/bg-desktop.png')] bg-cover bg-top w-full flex justify-end items-center">
      <div className="flex h-screen flex-col py-8 px-10 w-full items-end">
        ...
        <div className="flex-1 flex flex-col gap-8 w-full justify-center max-w-[600px]">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-semibold text-white [text-shadow:_0_2px_2px_rgb(0_0_0_/_60%)]">Pronto para a <span className="text-[#E8CF46]">decolagem?</span>🚀</h1>
